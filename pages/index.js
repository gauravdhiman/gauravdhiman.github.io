...
const Home = () => (
    <div>
        ...
        gtag('config', 'UA-6297967-3'); */}
            ...
            <title>Gaurav Dhiman - Technology leader with 23+ experience.</title>
                ...
                <div class="container">
                    <div class="media-container-column mbr-white col-lg-8 col-md-10">
                        ...
                        <h3 class="mbr-section-subtitle align-left mbr-light pb-3 mbr-fonts-style display-2">
                            with 23+ years of experience&nbsp;</h3>
                                    ...
                                    <div class="panel-item p-4 d-flex">
                                        ...
                                        <div class="card-text">
                                            ...
                                            <p class="mbr-content-text mbr-fonts-style display-7">- Understanding of broader technology landscape across Web, Mobile, Cloud, IoT, Big-Data and ML space.<br />
                                                ...
                                                - Hands on experience with prompt engineering, building RAGs & Agentic AI solutions using LLMs and frameworks like <a href="https://www.agno.com/" target="_blank">Agno</a>, <a href="https://www.langchain.com/" target="_blank">LangChain</a>, <a href="https://www.langchain.com/langgraph" target="_blank">LangGraph</a>, <a href="https://microsoft.github.io/autogen/stable//index.html" target="_blank">AutoGen</a>,, <a href="https://www.crewai.com/" target="_blank">CrewAI</a> etc. You can check the demos below.<br />
                        ...
                        <div class="row timeline-element reverse separline">
                            <div class="timeline-date-panel col-xs-12 col-md-6  align-left">
                                <div class="time-line-date-content">
                                    <p class="mbr-timeline-date mbr-fonts-style display-5">Aug 2022 - Apr 2025</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-6 align-right">
                                <div class="timeline-text-content">
                                    ...
                                    <p class="mbr-timeline-text mbr-fonts-style display-7">
                                        ...
                                        <br />
                                        - Led development of full-stack software tools / products in Meta's Ads Monetization group.<br />
                                        - Led development of GenAI based agentic solution using Llama LLM and Vector DB for sales-call analytics that summarizes call transcripts, extracts action items (with owners and due dates), and auto-schedules reminders—improving follow-up task completion and reducing missed opportunities.<br />
                                        - Developed systems for sales to enable high value advertisers ((HiVA - GBG) that are responsible for 75% of Meta's revenue.<br />
                                        - Collaborated with Cross-Functional (XFN) teams (Sales Operations, Product, UI/UX Design, Data Science, Data Engg, Software Engg) to gather requirements, ran 15+ discovery workshops and demo sessions — accelerating feature sign-off.<br />
                                        - Designed and delivered a scalable microservice leveraging Meta’s internal event-driven pipelines to power interactive performance dashboards — cutting report generation time<br />
                                        - Led design discussions and create system design and technical documentations.<br />
            ...
            <section class="section-table cid-rUGKfPPCp0" id="table1-e">
                <div class="container container-table">
                    <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">
                        Personal Projects, Demos &amp; Blogs</h2>
                    ...
                    <div class="table-wrapper">
                        ...
                        <div class="container scroll">
                            <table class="table" cellspacing="0">
                                <thead>
                                    <tr class="table-heads ">
                                        <th class="head-item mbr-fonts-style display-7">
                                            Description</th>
                                        <th class="head-item mbr-fonts-style display-7">Demo Link</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="body-item mbr-fonts-style display-7">Developed a fullstack AI Agentic App, for which I did the <a href="https://github.com/gauravdhiman/vercel-agno-integration/blob/main/server/agno_adapter.py" target="_blank">integration</a> between <a href={"https://ai-sdk.dev/docs/ai-sdk-ui"} target="_blank">Vercel AI-SDK-UI</a> and <a href={"https://www.agno.com/"} target="_blank">Agno AI Agentic Framework</a> to showcase the capabilities of AI Agents invoking frontend UI tools (Background color change, Generative UI, Human-in-the-loop etc.) as well as backend tools (Dockerized browser, Google Search, etc).</td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href={"https://www.linkedin.com/posts/gauravdhiman_agenticai-ai-agenticapp-activity-7327895915850092544-RWhf"} target="_blank">LinkedIn Post</a>
                                        </td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href=" https://github.com/gauravdhiman/vercel-agno-integration" target="_blank">Github Link</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="body-item mbr-fonts-style display-7">I did <a href="https://github.com/gauravdhiman/agno-copilotkit-integration/tree/main/backend/copilotkit_integration" target="_blank">integration</a> between <a href={"https://www.copilotkit.ai/"} target="_blank">CopilotKit UI Framework</a> and <a href={"https://www.agno.com/"} target="_blank">Agno AI Agentic Framework</a>. This showcase the capabilities of AI Agents invoking frontend UI tools (Background color change, Generative UI, Human-in-the-loop etc.) as well as backend tools (Dockerized browser, Google Search, etc).</td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            -NA-
                                        </td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href=" https://github.com/gauravdhiman/agno-copilotkit-integration" target="_blank">Github Link</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="body-item mbr-fonts-style display-7">AI Agent to Automate Web Browsering (Python). This is a python AI agentic project to automate the web browsing and actions without any human intervention.</td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href={"https://www.linkedin.com/posts/gauravdhiman_aiagents-opensource-browseruse-activity-7289650864724623360-ZliD"} target="_blank">LinkedIn Post</a>
                                        </td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            -NA-
                                        </td>
                                    ...
                                    <tr>
                                        <td class="body-item mbr-fonts-style display-7">Realtime Voice AI Agent (Python, NextJS, ReactJS). This project uses the open-source speech to speech model for conversational AI voice bot. It can be used for automating customer service, sales calls etc.</td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href={"https://www.linkedin.com/posts/gauravdhiman_realtime-voice-aiagent-activity-7287861578832453634-YWNp"} target="_blank">LinkedIn Post</a>
                                        </td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            -NA-
                                        </td>
                                    ...
                                    <tr>
                                        <td class="body-item mbr-fonts-style display-7">Local Podcast Generator (Python). This project uses the LLM to first generate the podcast script on given topic and then uses open-source text to speech (TTS) model (Kokoru) to generate audio for each speaker and stitches the whole audio to convert it into podcast. Here is the <a href={"https://www.linkedin.com/posts/gauravdhiman_free-opensource-llm-activity-7284230148424376320-T-rS"} target="_blank">generated post</a>.</td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href={"https://www.linkedin.com/posts/gauravdhiman_opensource-awesomeness-aiagent-activity-7286393147792801792-jmUt"} target="_blank">LinkedIn Post</a>
                                        </td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            -NA-
                                        </td>
                                    ...
                                    <tr>
                                        <td class="body-item mbr-fonts-style display-7">Chat with Any Database. This project shows the capabilities of AI agents to query any database and visualize the data as different graphs, but in natural language. To build this, I used an open-source AI agentic framework named <a href={"https://www.agno.com/"} target="_blank">Agno (earlier known as PhiData)</a>.</td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            <a href={"https://www.linkedin.com/posts/gauravdhiman_chat2db-agentic-ai-activity-7274438189811965952-bnao"} target="_blank">LinkedIn Post</a>
                                        </td>
                                        <td class="body-item mbr-fonts-style display-7">
                                            -NA-
                                        </td>
                        ...
                        <div class="media-container-row mbr-white">
                            ...
                            <div class="col-md-6">
                                <div class="social-list align-right">
                                    ...
                                    <div class="soc-item">
                                        <a href="https://twitter.com/gauravdhiman_ai/" target="_blank">
